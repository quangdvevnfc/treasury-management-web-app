      ...
      >
        ...
        <div>
          <h3 className="text-white mb-4">
            Jump start your project with Treasury Management
          </h3>
          <p className="text-lg text-white opacity-80 max-w-[700px]">
            Treasury Management comes with a complete set of UI components
            crafted with Tailwind CSS, it fulfilled most of the use case to
